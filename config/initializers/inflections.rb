...
ActiveSupport::Inflector.inflections do |inflect|
  ...
  inflect.singular(/(r|z)es$/i, '\1') # porque existe esse ?
  ...
  inflect.singular("users", "user")
  inflect.singular("status","status")
  inflect.singular("livres","livre")
  inflect.singular("municipais","municipal")
  inflect.singular("perfis","perfil")
  inflect.singular("logins", "login")
